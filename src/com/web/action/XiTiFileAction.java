...
import com.service.IXiTiService;
...
@Controller
@Scope("prototype")
public class XiTiFileAction extends ActionSupport {
    ...
    XiTiFile xiTiFile = new XiTiFile();

    @Autowired
    private IXiTiService xiTiService;
    ...
    public String upload() throws IOException {
        ...
        xiTiFile.setTitle(title);
        xiTiFile.setAuthor(author);
        xiTiFile.setDate(simpleDateFormat);
        xiTiFile.setFilePath(converfilename);
        xiTiFile.setUploadFileName(uploadFileName);
        xiTiService.save(xiTiFile);
    ...
    public String deleteById(){
       //先查询,再删除
        XiTiFile xiTiFile = xiTiService.findById(id);

       if(xiTiFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = xiTiFile.getFilePath();
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        XiTiFile file = xiTiService.findById(id);
    ...
    public String findAllHou () {
        List<XiTiFile> listhou = xiTiService.findAll();
    ...
    public String findAll () {
        List<XiTiFile> list = xiTiService.findAll();
