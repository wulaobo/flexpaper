...
import com.service.IJiaoXueService;
...
@Controller
@Scope("prototype")
public class JiaoXueFileAction extends ActionSupport {
    ...
    JiaoXueFile jiaoXueFile = new JiaoXueFile();

    @Autowired
    private IJiaoXueService jiaoXueService;
    ...
    public String upload() throws IOException {
        ...
        jiaoXueFile.setTitle(title);
        jiaoXueFile.setAuthor(author);
        jiaoXueFile.setDate(simpleDateFormat);
        jiaoXueFile.setFilePath(converfilename);
        jiaoXueFile.setUploadFileName(uploadFileName);
        jiaoXueService.save(jiaoXueFile);
    ...
    public String deleteById(){
       //先查询,再删除
        JiaoXueFile jiaoXueFile = jiaoXueService.findById(id);

       if(jiaoXueFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = jiaoXueFile.getFilePath();
           ...
           //删除数据库中的数据记录
           jiaoXueService.delete(jiaoXueFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        JiaoXueFile file = jiaoXueService.findById(id);
    ...
    public String findAllHou () {
        List<JiaoXueFile> listhou = jiaoXueService.findAll();
    ...
    public String findAll () {
        List<JiaoXueFile> list = jiaoXueService.findAll();
