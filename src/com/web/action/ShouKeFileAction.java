...
@Controller
@Scope("prototype")
public class ShouKeFileAction extends ActionSupport {
    ...
    ShouKeFile shouKeFile = new ShouKeFile();

    @Autowired
    private IShouKeService shoukeService;
    ...
    public String upload() throws IOException {
        ...
        shouKeFile.setTitle(title);
        shouKeFile.setAuthor(author);
        shouKeFile.setDate(simpleDateFormat);
        shouKeFile.setFilePath(converfilename);
        shouKeFile.setUploadFileName(uploadFileName);
        shoukeService.save(shouKeFile);
    ...
    public String deleteById(){
       //先查询,再删除
        ShouKeFile shouKeFile = shoukeService.findById(id);

       if(shouKeFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = shouKeFile.getFilePath();
           ...
           //删除数据库中的数据记录
           shoukeService.delete(shouKeFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        ShouKeFile file = shoukeService.findById(id);
    ...
    public String findAllHou () {
        List<ShouKeFile> listhou = shoukeService.findAll();
    ...
    public String findAll () {
        List<ShouKeFile> list = shoukeService.findAll();
