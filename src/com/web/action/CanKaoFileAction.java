...
import com.service.ICanKaoFileService;
...
@Controller
@Scope("prototype")
public class CanKaoFileAction extends ActionSupport {
    ...
    CanKaoFile canKaoFile = new CanKaoFile();

    @Autowired
    private ICanKaoFileService canKaoFileService;
    ...
    public String upload() throws IOException {
        ...
        canKaoFile.setTitle(title);
        canKaoFile.setAuthor(author);
        canKaoFile.setDate(simpleDateFormat);
        canKaoFile.setFilePath(converfilename);
        canKaoFile.setUploadFileName(uploadFileName);
        canKaoFileService.save(canKaoFile);
    ...
    //删除文件
    public String deleteCanKaoFileById(){
       //先查询,再删除
        CanKaoFile canKaoFile = canKaoFileService.findCanKaoFileById(id);

       if(canKaoFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = canKaoFile.getFilePath();
           ...
           //删除数据库中的数据记录
           canKaoFileService.deleteCanKaoFile(canKaoFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        CanKaoFile file = canKaoFileService.findCanKaoFileById(id);
    ...
    public String findAllHou () {
        List<CanKaoFile> listhou = canKaoFileService.findAllCanKaoFile();
        ActionContext.getContext().getSession().put("listhou",listhou);
        return "listhou";
    }

    //查询文件列表
    public String findAllCanKaoFile () {
        List<CanKaoFile> list = canKaoFileService.findAllCanKaoFile();
