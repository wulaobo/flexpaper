...
import com.service.IShiJuanService;
...
@Controller
@Scope("prototype")
public class ShiJuanFileAction extends ActionSupport {
    ...
    ShiJuanFile shiJuanFile = new ShiJuanFile();

    @Autowired
    private IShiJuanService shijuanService;
    ...
    public String upload() throws IOException {
        ...
        shiJuanFile.setTitle(title);
        shiJuanFile.setAuthor(author);
        shiJuanFile.setDate(simpleDateFormat);
        shiJuanFile.setFilePath(converfilename);
        shiJuanFile.setUploadFileName(uploadFileName);
        shijuanService.save(shiJuanFile);
    ...
    public String deleteById(){
       //先查询,再删除
        ShiJuanFile shiJuanFile = shijuanService.findById(id);

       if(shiJuanFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = shiJuanFile.getFilePath();
           ...
           //删除数据库中的数据记录
           shijuanService.delete(shiJuanFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        ShiJuanFile file = shijuanService.findById(id);
    ...
    public String findAllHou () {
        List<ShiJuanFile> listhou = shijuanService.findAll();
    ...
    public String findAll () {
        List<ShiJuanFile> list = shijuanService.findAll();
