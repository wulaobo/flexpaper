...
import com.service.IShiYanService;
...
@Controller
@Scope("prototype")
public class ShiYanFileAction extends ActionSupport {
    ...
    ShiYanFile shiYanFile = new ShiYanFile();

    @Autowired
    private IShiYanService shiYanService;
    ...
    public String upload() throws IOException {
        ...
        shiYanFile.setTitle(title);
        shiYanFile.setAuthor(author);
        shiYanFile.setDate(simpleDateFormat);
        shiYanFile.setFilePath(converfilename);
        shiYanFile.setUploadFileName(uploadFileName);
        shiYanService.save(shiYanFile);
    ...
    public String deleteById(){
       //先查询,再删除
        ShiYanFile shiYanFile = shiYanService.findById(id);

       if(shiYanFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = shiYanFile.getFilePath();
           ...
           //删除数据库中的数据记录
           shiYanService.delete(shiYanFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        ShiYanFile file = shiYanService.findById(id);
    ...
    public String findAllHou () {
        List<ShiYanFile> listhou = shiYanService.findAll();
    ...
    public String findAll () {
        List<ShiYanFile> list = shiYanService.findAll();
