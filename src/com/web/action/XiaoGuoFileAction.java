...
import com.service.IShouKeService;
import com.service.IXiaoGuoService;
...
@Controller
@Scope("prototype")
public class XiaoGuoFileAction extends ActionSupport {
    ...
    XiaoGuoFile xiaoGuoFile = new XiaoGuoFile();

    @Autowired
    private IXiaoGuoService xiaoGuoService;
    ...
    public String upload() throws IOException {
        ...
        xiaoGuoFile.setTitle(title);
        xiaoGuoFile.setAuthor(author);
        xiaoGuoFile.setDate(simpleDateFormat);
        xiaoGuoFile.setFilePath(converfilename);
        xiaoGuoFile.setUploadFileName(uploadFileName);
        xiaoGuoService.save(xiaoGuoFile);
    ...
    public String deleteById(){
       //先查询,再删除
        XiaoGuoFile xiaoGuoFile = xiaoGuoService.findById(id);

       if(xiaoGuoFile!=null){
           //删除上传目录的doc文件
           String filePathdoc = xiaoGuoFile.getFilePath();
           ...
           //删除数据库中的数据记录
           xiaoGuoService.delete(xiaoGuoFile);
           return "del";
       }
       return "error";
    }
    ...
    public String preview() throws Exception {
        ...
        //根据id查询KeChengFile
        XiaoGuoFile file = xiaoGuoService.findById(id);
    ...
    public String findAllHou () {
        List<XiaoGuoFile> listhou = xiaoGuoService.findAll();
    ...
    public String findAll () {
        List<XiaoGuoFile> list = xiaoGuoService.findAll();
