...
//            window.opener.document.location.reload();
            ...
            function preview(swfpath,id1) {
                ...
                <%--location.href="${ pageContext.request.contextPath }/keChengFileAction_findById?id1="+id1;--%>
                window.open("${pageContext.request.contextPath}/keChengFileAction_preview?path="+path+"id1="+id1);
            }
		</script>
	</head>
	<body>
									...
									<s:iterator value="#session.list" id="File">
										<li>
											<a href="" > <img class="indexpic" src="${pageContext.request.contextPath}/img/shiyan.png"/>
												<span class="title" onclick=" preview('<s:property value="#File.uploadFileName"/>','<s:property value="#File.id"/>')"><s:property value="#File.title"></s:property></span></a>
