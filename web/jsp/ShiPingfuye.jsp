...
//            window.opener.document.location.reload();
            ...
            <%--}--%>
            function preview(id1) {
                <%--var path="upload/"+swfpath;--%>
                window.open("${pageContext.request.contextPath}/fileUpLoadAction_preview?filePath="+id1);
            }
		</script>
	</head>
	<body>
									...
									<s:iterator value="#session.list" id="File">
										<li>
											<a href="" > <img class="indexpic" src="${pageContext.request.contextPath}/img/shiyan.png"/>
												<span class="title" onclick=" preview('<s:property value="#File.filePath"></s:property>')"><s:property value="#File.title"></s:property></span></a>
